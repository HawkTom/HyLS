...
typedef struct remain_state
{
    int point[101];
    int rcap[101];
    int rroutes[101][MAX_TASK_SEQ_LENGTH];
} Rmstate;


extern Individual best_si_solution;
extern Individual best_di_solution;
extern Individual best_swap_solution;
extern Individual best_rev_solution;
extern Individual best_cross_solution;

extern Individual best1_si_solution;
extern Individual best1_di_solution;
extern Individual best1_swap_solution;
extern Individual best1_rev_solution;
extern Individual best1_cross_solution;

extern Individual best_lma_solution;
