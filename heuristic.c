...
//        memcpy(ps_indi->Loads, tmp_indi5.Loads, (tmp_indi5.Loads[0]+1)*sizeof(int));
...
//    load = 0;
//    j = 0;
//    for (i = 1; i <= ps_indi->Sequence[0]; i++)
//    {
//        if (ps_indi->Sequence[i] == 0)
//        {
//            printf("%d %d\n", load, ps_indi->Loads[j]);
//            load = 0;
//            j ++;
//            continue;
//        }
//        load += inst_tasks[ps_indi->Sequence[i]].demand;
//    }
//    printf("%d %d \n", ps_indi->TotalCost, get_task_seq_total_cost(ps_indi->Sequence, inst_tasks));
}
